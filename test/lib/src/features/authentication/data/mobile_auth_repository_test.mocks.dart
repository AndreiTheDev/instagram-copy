...
// in instagram_copy/test/lib/src/features/authentication/data/mobile_auth_repository_test.dart.
...
class MockHttpsCallable extends _i1.Mock implements _i4.HttpsCallable {
  ...
  _i5.Future<_i4.HttpsCallableResult<T>> call<T>([dynamic parameters]) =>
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _i5.Future<_i4.HttpsCallableResult<T>>.value(
            _FakeHttpsCallableResult_4<T>(
          this,
          Invocation.method(
            #call,
